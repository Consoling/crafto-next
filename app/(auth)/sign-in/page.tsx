...
const SignIn = () => {
  ...
  return (
    <div
      ...
      style={{ backgroundImage: "url('/assets/bg-crafto.png')" }}
    >
        ...
        <div className="w-full max-w-md bg-white/90 p-10  rounded-3xl shadow-lg">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <h2 className="text-center text-3xl font-semibold mb-6">
              ...
              <span className="block text-3xl font-extrabold text-[#fd4878]">
                Perfect Photo Frame
              </span>
            </h2>
            ...
            <div className="mb-6 relative">
              ...
              <button
                ...
                className="absolute right-3 top-3 text-gray-500 hover:text-[#fd4878] transition cursor-pointer"
              >
              ...
              <Link
                ...
                className="absolute right-3 -bottom-7 text-sm text-[#fd4878] font-semibold"
              >
                Forgot Password?
              </Link>
            </div>
            ...
            <div className="mt-6 text-center text-sm">
              ...
              <Link href="/sign-up" className="text-[#fd4878] font-semibold">
                Create Account
              </Link>
            </div>
          </form>
